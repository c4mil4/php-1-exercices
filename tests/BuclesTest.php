...
final class BuclesTest extends TestCase
{
    ...
    public function testEjercicio1(): void
    {
        ...
        // Conseguir un array con los correos de los usuarios utilizando foreach  assertEquals(['carlos@correo.com','carmen@correo.com','carmelo@correo.com','carolina@correo.com'], $emails);
    }
    public function testEjercicio2(): void
    {
      ...
      $employees[$key]['email']= str_replace('.net', '.com', $employee['axuyetg@']);
    }
